...
from PyQt6.QtWidgets import QWidget, QLineEdit, QPushButton, QProgressBar, QFileDialog, QMainWindow
...
class Ui_MainWindow(QMainWindow):
    def __init__(self):
        ...
        # self.delay_text_box.setGeometry(QRect(10, 40, 141, 20));
        ...
        # self.volume_text_box.setGeometry(QRect(160, 40, 101, 20));
        ...
        # self.audio_ratio_text_box.setGeometry(QRect(190, 71, 71, 20));
        ...
        # self.video_Button.setGeometry(QRect(10, 100, 61, 21));
        ...
        # self.audio_Button.setGeometry(QRect(10, 130, 61, 21));
        ...
        # self.video_text_box.setGeometry(QRect(80, 101, 181, 21));
        ...
        # self.audio_text_box.setGeometry(QRect(80, 130, 181, 21));
        ...
        # self.load_button.setGeometry(QRect(10, 160, 61, 21));
        ...
        # self.encode_Button.setGeometry(QRect(80, 160, 121, 21));
    ...
    def check_inputs_and_Encode(self):
        try:
            ...
            if "/" not in self.output_text_box.text():
                raise ravioli.OutputLoadError();
            if not re.match(r'\d', self.delay_text_box.text()):
                raise ValueError('You must provide delay in milliseconds');
            ...
            else: raise ravioli.VideoLoadError();
            if "/" not in self.audio_text_box.text():
                raise ravioli.AudioLoadError();
        ...
        except ravioli.OutputLoadError: ravioli.Ui_Error_Output_Load();
        except AttributeError: ravioli.Ui_Error_load_from_database();
        except ValueError: ravioli.Ui_Error_Delay();
        except ravioli.VideoLoadError: ravioli.Ui_Error_Video_load();
        except ravioli.AudioLoadError: ravioli.Ui_Error_Audio_load();
